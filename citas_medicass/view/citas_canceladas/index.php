							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
                                        ...
                                        <h1 class="text-success">Citas canceladad aquí</h1>
										                  <!------------------- table  ----------------------->                
                            ...
                            <div class="table-responsive" >
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="btn-tel" scope="col">ID Paciente</th>
                                    ...
                                    <tbody>
										...
										<?php
													...
													$con = connect();
														...
														if (isset($_POST['enviar_id'])) {
															...
															$sql = "DELETE FROM cancelar_cita WHERE `cancelar_cita`.`id_cita` = $id";
															...
															if($result){
																...
																$redireccion = '<script>
																	setTimeout(function() {
																		window.location.href = "../folder/citas_canceladas.php";
																	}, 3000);
																</script>';
										...
										if (isset($mensaje)) {
											...
											?>	
													...
													$sql = "SELECT cancelar_cita.id_cita, cancelar_cita.nombre, cancelar_cita.cedula, cancelar_cita.fecha,  cancelar_cita.motivos, cancelar_cita.atencionmedica,  customers.nombrep, customers.codpaci
													FROM cancelar_cita
